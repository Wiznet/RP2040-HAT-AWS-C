...
RP2040-HAT-AWS-C
曳 port
    曳 aws-iot-device-sdk-embedded-C
    早   曳 inc
    早   早   曳 core_http_config.h
    早   早   曳 core_mqtt_config.h
    早   早   曳 dns_config.h
    早   早   曳 dns_interface.h
    早   早   曳 http_transport_interface.h
    早   早   曳 mqtt_transport_interface.h
    早   早   曳 ssl_transport_interface.h
    早   早   曳 timer_interface.h
    早   早   曲 util.h
	早   曲 src
    早   早   曳 dns_interface.c
    早   早   曳 http_transport_interface.c
    早   早   曳 mqtt_transport_interface.c
    早   早   曳 ssl_transport_interface.c
    早   早   曳 timer_interface.c
    早   早   曲 util.c
    曳 ioLibrary_Driver
    早   曳 w5x00_spi.c
    早   曲 w5x00_spi.h
